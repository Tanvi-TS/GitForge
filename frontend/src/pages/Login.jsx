...
const Login = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#f6f8fa] px-4">
      {/* GitHub Logo Icon */}
      ...
      <h2 className="text-2xl font-medium mb-4 text-[#1f2328]">Sign in to GitForge</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="text-sm font-normal text-[#1f2328]">
                Password
              </label>
              <Link to="#" className="text-xs text-[#0969da] hover:underline">Forgot password?</Link>
            </div>
            <input
              type="password"
      ...
      {/* Register Section */}
      <div className="max-w-[340px] w-full mt-4 border border-[#d0d7de] rounded-md p-4 text-center">
